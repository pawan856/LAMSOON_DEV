<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RPT_SHORTLEN.aspx.vb" Inherits="RPT_SHORTLEN_main" %>
            ...
            <table border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="TITLE" colspan ="2">
                        <b><asp:Label ID="lheader" runat="server" text="Short Length Cable Summary Report" /></b>
                    </td>
                 </tr>
            </table>
        </td>
