<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CC_PLAN.aspx.vb" Inherits="RPT_SLDTL_main" %>
            ...
            <table border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="TITLE" colspan ="2">
                        <b><asp:Label ID="lheader" runat="server" text="Master Cycle Count Plan" /></b>
                    </td>
                 </tr>
            </table>
        </td>
