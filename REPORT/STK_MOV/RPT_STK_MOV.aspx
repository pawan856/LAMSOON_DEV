<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RPT_STK_MOV.aspx.vb" Inherits="RPT_SLCABLE_RCD_main" %>
            ...
            <table border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="TITLE" colspan ="2">
                        <b><asp:Label ID="lheader" runat="server" text="Stock Movement Report" /></b>
                    </td>
                 </tr>
            </table>
        </td>
