<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PackList.aspx.vb" Inherits="OUTBOUND_DO_Pack_list" %>
...
<body>
    ...
    <div>
         <rsweb:ReportViewer ID="ReportViewer1" runat="server" font-size="8pt"
            height="580px" style="position: static" width="820px"></rsweb:ReportViewer>
    </div>
    </form>
</body>
</html>
