...
<script language="javascript">
    ...
    function PrintLabel(STORER_CODE, itemStr, ro_code) {
            ...
            setInterfaceDataToForm(document.hiddenForm, "DOC_NO", ro_code);
            setInterfaceDataToForm(document.hiddenForm, "lblType", "DO");
    ...
    function PrintLabelCable(STORER_CODE, itemStr, ro_code) {
        removeAllElementFromForm(document.hiddenForm);
        ...
        <tr>
            <td>
                <asp:GridView ID="GridView1" runat="server" Height="10px" Width="100%" Font-Names="Arial"
                     ...
                     CellPadding="3" CaptionAlign="Top" DataKeyNames="PLD_SEQ" HorizontalAlign="Left">
                      ...
                      <Columns>
                         <asp:TemplateField >
                            ...
                            <ItemTemplate>
                                ...
                                <asp:HiddenField runat="server" ID="PLD_SEQ" />
                         ...
                         <asp:BoundField runat="server" DataField="PLD_PACK_KEY" HeaderText="Pack Key" HeaderStyle-HorizontalAlign="Left" />
                         <asp:BoundField runat="server" DataField="PLD_PALLET_NO" HeaderText="Pallet No" HeaderStyle-HorizontalAlign="Left" />
                         <asp:BoundField runat="server" DataField="PLD_BATCH_NO" HeaderText="Batch No" HeaderStyle-HorizontalAlign="Left" />
                         <asp:BoundField runat="server" DataField="ITM_NAME" HeaderText="Item Name" HeaderStyle-HorizontalAlign="Left" />
                         <asp:BoundField runat="server" DataField="PLD_LOC" HeaderText="Location" HeaderStyle-HorizontalAlign="Left" />
