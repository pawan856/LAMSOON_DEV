<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PickSerialLookupSplit.aspx.vb" Inherits="OUTBOUND_DO_PickSerialLookupSplit" %>
            ...
            <asp:GridView ID="GridView1" runat="server" Height="10px" Width="100%" Font-Names="Arial"
                ...
                <Columns>
                    <asp:TemplateField HeaderText="FFI Qty">
                        ...
                        <ItemTemplate>
                            <asp:TextBox ID="ffi_qty2" runat="server" Font-Size="11px" maxlength="12" style="text-align:right" />
