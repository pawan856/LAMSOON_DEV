<%@ Page Language="VB" AutoEventWireup="false" CodeFile="DriverDeliNote.aspx.vb" Inherits="OUTBOUND_DO_D_DELI_NOTE_DriverDeliNote" %>
...
<body>
    ...
    <div>
         <rsweb:ReportViewer ID="ReportViewer1" runat="server" font-size="8pt"
            height="400px" style="position: static" width="750px"></rsweb:ReportViewer>
    </div>
    </form>
</body>
</html>
