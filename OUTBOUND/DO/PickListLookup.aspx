<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PickListLookup.aspx.vb" Inherits="OUTBOUND_DO_PickListLookup" %>
...
<table border="0" cellspacing="1" cellpadding="1" align="center" style="width: 700px">
   <tr>
    ...
    <tr>
        ...
        <td class="LabelTD" nowrap width="90px">
            <font size="2">
                <asp:Label ID="lbl_REQ_QTY" runat="server" /></font>
        </td>
        <td nowrap>
            <font size="2">
                <asp:Label ID="REQ_QTY" runat="server" style="text-align:right" />
            </font>
        </td>
    </tr>
    <tr>
            ...
            <asp:GridView ID="GridView1" runat="server" Height="10px" Width="100%" Font-Names="Arial"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="FFI Qty">
                        ...
                        <ItemTemplate>
                            <asp:TextBox ID="foi_qty" runat="server" Font-Size="11px" maxlength="12" style="text-align:right"></asp:TextBox>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="RCV Qty">
                        ...
                        <ItemStyle HorizontalAlign="Right" />
                        <ItemTemplate>
                            <asp:Label ID="gra_pa_qty" runat="server" Font-Size="11px" style="text-align:right" />
                        </ItemTemplate>
                    </asp:TemplateField>
