...
Partial Class OUTBOUND_DO_PICKING_LIST_picking_list
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            sqlString = "SELECT WMS_DELV_ORDER_D.DOD_REM,WMS_DELV_ORDER_D.DOD_FL_CODE,WMS_DELV_ORDER_D.DOD_WH_CODE,WMS_DELV_ORDER_D.DOD_LOC_WH,WMS_DELV_ORDER_D.DOD_SEQ, WMS_ITEM.ITM_SKU_NO,WMS_DELV_ORDER_D.DOD_EXPIRY_DATE, WMS_DELV_ORDER_D.DOD_QTY, WMS_DELV_ORDER_D.DOD_ITM_DESC, WMS_DELV_ORDER_D.DOD_SS_QTY,WMS_DELV_ORDER_D.DOD_CUS_NAME " &
                    " FROM WMS_DELV_ORDER_D INNER JOIN " &
                            ...
                            " WMS_DELV_ORDER_D.DOD_ITM_CODE = WMS_ITEM.ITM_CODE And WMS_DELV_ORDER_D.DOD_PACK_KEY = WMS_ITEM.PACK_KEY " &
