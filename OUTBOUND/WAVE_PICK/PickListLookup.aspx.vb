...
Partial Class OUTBOUND_DO_PickListLookup
    ...
    Protected Sub GridView1_RowCreated(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles GridView1.RowCreated
        Select Case e.Row.RowType
            Case DataControlRowType.Header
                ...
                Call cU.changeGVLabel(oGridViewRow, e, "FFI Qty", "領取數量", HorizontalAlign.Right)
                Call cU.changeGVLabel(oGridViewRow, e, "RCV Qty", "收貨數量", HorizontalAlign.Right)
                Call cU.changeGVLabel(oGridViewRow, e, "Stock Qty", "架上數量", HorizontalAlign.Right)
    ...
    Protected Sub GridView1_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles GridView1.RowDataBound
        Select Case e.Row.RowType
            Case DataControlRowType.DataRow
                ...
                Dim pl_dt As DataTable = Session("WPpkListDT")
                Dim i As Integer

                For i = 0 To pl_dt.Rows.Count - 1
                    If pl_dt.Rows(i).Item("DO_CODE").ToString = ITM_CODE.Text And _
                    pl_dt.Rows(i).Item("PLD_ITEM_NO").ToString = ITM_CODE.Text And _
    ...
    Protected Sub save(Optional ByVal flag As String = "")
        If GridView1.Rows.Count > 0 Then
            ...
            reqQty = CDbl(gU.decodeEmptyCdbl(REQ_QTY.Text, 0))
                        ...
                        If gU.decodeNullOrEmpty(DB.decodeDBNull(dt.Rows(i).Item("FOI_QTY"), 0), 0) > 0 Then
                            ...
                            For j = 0 To pl_dt.Rows.Count - 1
                                If pl_dt.Rows(j).Item("mFlag").ToString <> "D" Then
                                    If pl_dt.Rows(j).Item("DO_CODE").ToString = DO_CODE.Value And _
                                        pl_dt.Rows(j).Item("PLD_ITEM_NO").ToString = ITM_CODE.Text And _
                            ...
                            If Not isPlUpdt Then
                                ...
                                pl_dt.Rows(rows_count - 1).Item("DO_CODE") = DO_CODE.Value
                                pl_dt.Rows(rows_count - 1).Item("DO_CO_CODE") = CO_CODE.Value
    ...
    Protected Sub BindGV()
        ...
        SQLstring = "SELECT d.DOD_SEQ, d.DOD_DISP_SEQ, d.DOD_PALLET_NO, d.DOD_CARTON_NO, d.DOD_PACK_NO, d.DOD_ITM_CODE, d.DOD_PACK_KEY, " & _
                        "d.DOD_ITM_DESC, d.DOD_PACK_TYPE, d.DOD_QTY, d.DOD_UOM, d.DOD_PCS_UOM, d.DOD_TOTPCS, d.DOD_TOT_WGT, d.DOD_TOT_CBM, " & _
                        ...
                        "'U' as mFlag, 1 as label_qty, '' as dod_ref_no, d.DOD_TROLLEY_ID " & _
                    ...
                    "where d.DO_CODE = '" & gU.dbEncode(DO_CODE.Value) & "' " & _
                    "and d.STORER_CODE = '" & gU.dbEncode(STORER_CODE.Value) & "' " & _
        ...
        dtl_dt = gDB.getDataTable(SQLstring)
        ...
        selectSql = "select l.ILOC_PALLET_NO, l.ILOC_BAL_QTY, l.ILOC_LOC, l.ILOC_WH, l.ILOC_FLOOR, l.ILOC_AREA, l.ILOC_RACK, l.ILOC_BIN, l.ILOC_BATCH_NO, r.GRA_PA_QTY, " & _
                    ...
                    "from WMS_ITEM_LOC_BAL l left outer join (" & _
