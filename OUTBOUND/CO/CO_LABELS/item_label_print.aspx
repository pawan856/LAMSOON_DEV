...
<script language="javascript">
    ...
    function PrintLabel(STORER_CODE, itemStr, ro_code) {
            ...
            setInterfaceDataToForm(document.hiddenForm, "lblType", "CO");
        ...
        <tr>
            <td>
                <asp:GridView ID="GridView1" runat="server" Height="10px" Width="100%" Font-Names="Arial"
                     ...
                     CellPadding="3" CaptionAlign="Top" DataKeyNames="COD_seq" HorizontalAlign="Left">
                      ...
                      <Columns>
                         ...
                         <asp:BoundField runat="server" DataField="COD_PACK_KEY" HeaderText="Pack Key" HeaderStyle-HorizontalAlign="Left" />
                         <asp:BoundField runat="server" DataField="COD_PALLET_NO" HeaderText="Pallet No" HeaderStyle-HorizontalAlign="Left" />
                         <asp:BoundField runat="server" DataField="COD_BATCH_NO" HeaderText="Batch No" HeaderStyle-HorizontalAlign="Left" />
                         <asp:BoundField runat="server" DataField="COD_ITM_DESC" HeaderText="Item Name" HeaderStyle-HorizontalAlign="Left" />
