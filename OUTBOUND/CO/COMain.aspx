<%@ Page Language="VB" AutoEventWireup="false" CodeFile="COMain.aspx.vb" Inherits="OUTBOUND_COMain" MaintainScrollPositionOnPostback="true" %>
...
//            document.getElementById(returnVendInfo.PCS_UOM_ID).value = returnVendInfo.PCS_UOM;
    ...
    window.open("", "coItemLbls", "titlebar=0,location=0,menubar=0,toolbar=0,scrollbars=yes,personalbar=0,status=1,width=900,height=600,left=5,top=15");

    setInterfaceDataToForm(document.hiddenForm, "co_code", document.getElementById("CO_CODE").innerHTML);
    setInterfaceDataToForm(document.hiddenForm, "storer_code", document.getElementById("STORER_CODE").value);
   
    document.hiddenForm.action = "CO_LABELS/item_label_print.aspx";
    document.hiddenForm.target = "coItemLbls";
    document.hiddenForm.submit();
}
    ...
    setInterfaceDataToForm(document.hiddenForm, "DOC_TYPE", "OB_CO");
                if (document.myform.editMode.value != "V") {
    setInterfaceDataToForm(document.hiddenForm, "DOC_NO", document.getElementById("CO_CODE").innerHTML);
    setInterfaceDataToForm(document.hiddenForm, "storer_code", document.getElementById("STORER_CODE").value);
            } else {
    setInterfaceDataToForm(document.hiddenForm, "DOC_NO", document.getElementById("CO_CODE").innerHTML);
    ...
    <div id="div1">
        <table border="0" cellspacing="1" cellpadding="1" align="center" width="100%">
            ...
            <tr>
                ...
                <tr>
                    <td class="menuTD" align="left">
                        ...
                        <asp:Button ID="btnConfirm" Text="Closed" CssClass="all_button" Visible="false" runat="server" />
                        <asp:Button ID="btnClose" Text="Close" CssClass="all_button" runat="server" />
                        ...
                        <% Elseif Session("gLang") = "C" Then %>value="返回" <% End If%> onclick="Javascript:window.location='<% if ViewState("FrmUP") <>"Y" then %>../../cms_search.aspx?menu_code=OB_CO <%else %>../../IMPORT/UL_CO/UploadCO.aspx<%end if %>'"
                            class="all_button" />
                    </td>
                    <td class="menuTD" align="right">
                        <asp:Button runat="server" id="btnPrintPalletLabel" Text="Print Pallet Label" CssClass="all_button"/>
                        <asp:Button runat="server" id="btnTrack" Text="Order Tracking" CssClass="all_button" OnClientClick="javascript:OpenTrack();return false;" />
                        ...
                        <asp:Button runat="server" ID="cSBBtn" Text="Check Stock Balance" CssClass="all_button"/>
                   </td>
                </tr>
               </table>                    
              </td>
            ...
            <tr>
                ...
                <td>
                    <font size="2">
                        ...
                        <asp:HiddenField runat="server" id="CO_DATA_FR" />
                    </font>
                </td>
                <td class="LabelTD" nowrap>
                    <font size="2">
            ...
            <tr>
               ...
               <%-- <td class="LabelTD" nowrap>
                    <font size="2">
                        <asp:Label ID="lbl_CO_TRACK_NO" runat="server" /></font>
                </td>
                <td colspan="3">
            ...
            <tr>
                ...
                <td>
                    <font size="2">
                        <asp:TextBox ID="CO_CUS_REF_NO" runat="server" MaxLength="20" Width="130px" Visible="false"></asp:TextBox>
                        <asp:TextBox ID="CO_EDI_SIR_NO" runat="server" MaxLength="20" Width="130px"></asp:TextBox>                        
                    </font>
                </td>
                <td class="LabelTD" nowrap>
                    <font size="2">
                        <asp:Label ID="lbl_CO_INV_NO" runat="server" /></font>
                </td>
                <td colspan="3">
                    <font size="3">
            ...
            <tr>
                ...
                <td colspan="3">
                    <font size="3">
                        <asp:TextBox ID="ROUTE_ID" runat="server" MaxLength="20" Width="130px"></asp:TextBox>
                    </font>
                </td>
            </tr>
            <tr>
                <td class="LabelTD" nowrap>
                    <font size="2">
                        <asp:Label ID="lbl_CO_FTRACK_NO" runat="server" /></font>
                </td>
                <td colspan="5">
            ...
            <tr>
                <td class="LabelTD" nowrap>
                    <font size="2">
                        <asp:Label ID="lbl_CO_SENDER" runat="server" /></font>
                </td>
                <td>
                    <asp:TextBox ID="CO_SENDER" runat="server" MaxLength="100" ></asp:TextBox>
                </td>
                <td class="LabelTD" nowrap>
                    <font size="2">
                        <asp:Label ID="lbl_CO_SENDER_TEL" runat="server" /></font>
                </td>
                <td colspan="3">
                    <asp:TextBox ID="CO_SENDER_TEL" runat="server" MaxLength="100"></asp:TextBox>
                </td>         
            </tr>
            <tr>
                <td class="LabelTD" nowrap>
                    <font size="2">
                        <asp:Label ID="lbl_CO_SENDER_ADDR" runat="server" /></font>
                </td>
                <td colspan="5">
                    <asp:TextBox ID="CO_SENDER_ADDR" runat="server" TextMode="MultiLine" Rows="3" Width="600px"></asp:TextBox>
                </td>         
            </tr>
            <tr>
                <td class="LabelTD" nowrap>
                    <font size="2">
                        <asp:Label ID="lbl_CO_SENDER_REGION" runat="server" /></font>
                </td>
                <td>
                    <asp:TextBox ID="CO_SENDER_REGION" runat="server" MaxLength="100" ></asp:TextBox>
                </td>
                <td class="LabelTD" nowrap>
                    <font size="2">
                        <asp:Label ID="lbl_CO_SENDER_PROVINCE" runat="server" /></font>
                </td>
                <td>
                    <asp:TextBox ID="CO_SENDER_PROVINCE" runat="server" MaxLength="100" ></asp:TextBox>
                </td>
                <td class="LabelTD" nowrap>
                    <font size="2">
                        <asp:Label ID="lbl_CO_SENDER_COUNTRY" runat="server" /></font>
                </td>
                <td>
                    <asp:TextBox ID="CO_SENDER_COUNTRY" runat="server" MaxLength="100" ></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="LabelTD" nowrap>
                ...
                <td colspan="5">
                    ...
                    <td width="50px" runat="server">
                        ...
                        <asp:TextBox ID="CO_PROJECT_NO" runat="server" MaxLength="100" ></asp:TextBox>
                    </td>
                    <td><font size="2"><asp:textbox ID="PRJ_NAME" runat="server" ReadOnly="true" BackColor="#dddddd" Width="365px" Visible="false" /></font></td>
                    </tr>
                    </table>
                </td>
            </tr>
            <tr>
                ...
                <td colspan="5">
                    ...
                    <td><font size="2"><asp:textbox ID="CUS_NAME" runat="server" Width="365px" /></font></td>
                    </tr>
                    </table>
                </td>
            </tr>
            <tr>
                <td class="LabelTD" nowrap>
                        <asp:Label ID="lbl_CO_DELIVER_TO" runat="server" />
                </td>
                <td colspan="5">
                        <asp:TextBox ID="CO_DELIVER_TO" runat="server" MaxLength="100" Width="494px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="LabelTD" nowrap>
            ...
            <tr>
                <td class="LabelTD" nowrap>
                    <font size="2">
                        <asp:Label ID="lbl_CO_PROVINCE" runat="server" /></font>
                </td>
                <td>
                    <font size="2">
                        <asp:TextBox ID="CO_PROVINCE" runat="server" MaxLength="200" />
                    </font>
                </td>
                <td class="LabelTD" nowrap>
                    <font size="2">
                        <asp:Label ID="lbl_CO_CITY" runat="server" /></font>
                </td>
                <td>
                    <font size="2">
                        <asp:TextBox ID="CO_CITY" runat="server" MaxLength="200" />
                    </font>
                </td>
             </tr>
             <tr>
                    ...
                    <asp:GridView ID="GridView1" runat="server" Height="10px" Width="100%" Font-Names="Arial"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="WH">
                                ...
                                <HeaderStyle HorizontalAlign="Left" />
                                <ItemTemplate>
                                    <asp:TextBox ID="COD_WH_CODE" runat="server" Font-Size="11px" Width="50px" MaxLength="20"></asp:TextBox>
                                </ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Req By">
                                ...
                                <HeaderStyle HorizontalAlign="Left" />
                                <ItemTemplate>
                                    <asp:TextBox ID="COD_REQ_BY" runat="server" Font-Size="11px" Width="50px" MaxLength="20"></asp:TextBox>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Left" />
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="Ticket No.">
                                ...
                                <HeaderStyle HorizontalAlign="Left" />
                                <ItemTemplate>
                                    <asp:TextBox ID="COD_TICKET_NO" runat="server" Font-Size="11px" Width="90px" MaxLength="20"></asp:TextBox>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Left" />
                            </asp:TemplateField>                            
                            ...
                            <asp:TemplateField HeaderText="Batch No.">
                                <HeaderStyle HorizontalAlign="Left" />
                                <ItemTemplate>
                                    <asp:Dropdownlist ID="cod_batch_no" runat="server" Font-Size="11px" AutoPostBack="true" OnSelectedIndexChanged="ddl_BatchChanged"  />
                            ...
                            <asp:TemplateField HeaderText="Lot No.">
                                ...
                                <HeaderStyle HorizontalAlign="Left" />
                                <ItemTemplate>
                                    <asp:label ID="cod_lot_no" runat="server" Font-Size="11px" Width="90px" MaxLength="20"></asp:label>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Left" />
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="Expiry Date">
                                ...
                                <ItemTemplate>
                                     <asp:TextBox ID="cod_expiry_date" runat="server" Width ="80" MaxLength="10" Font-Size="11px" onkeypress="return maskDate(event);"></asp:TextBox>
                                     ...
                                     <asp:CalendarExtender ID="calEXP" runat="server" CssClass="ajax_calendar" 
                                            TargetControlID="cod_expiry_date" PopupButtonID="btnCal01" Format="dd/MM/yyyy" />
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Manufactory Date">
                                ...
                                <ItemStyle Wrap="false" />
                                <ItemTemplate>
                                     <asp:TextBox ID="cod_manu_date" runat="server" Width ="80" MaxLength="10" Font-Size="11px" onkeypress="return maskDate(event);"></asp:TextBox>
                                     ...
                                     <asp:CalendarExtender ID="calMANU" runat="server" CssClass="ajax_calendar" 
                                            TargetControlID="cod_manu_date" PopupButtonID="btnCal02" Format="dd/MM/yyyy" />
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="QTY2">
                                ...
                                <HeaderStyle HorizontalAlign="Left" />
                                <ItemTemplate>
                                    <asp:TextBox ID="cod_qty2" runat="server" Font-Size="11px" Width="60px" style="text-align:right" onkeypress="return maskKey(event);" />
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Left" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="UOM2">
                                ...
                                <HeaderStyle HorizontalAlign="Left" />
                                <ItemTemplate>
                                    <asp:DropDownList ID="cod_uom2" runat="server" Font-Size="11px" Enabled="false" />
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Left" />
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="Hold Qty.">
                                ...
                                <HeaderStyle HorizontalAlign="Left" />
                                <ItemTemplate>
                                    <asp:textbox ID="HOLD_QTY" runat="server" style="text-align:right" Font-Size="11px" BorderStyle="None" BackColor="#F0F0F0"/>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Right" />
                            </asp:TemplateField>
                            <asp:TemplateField ControlStyle-Width="50px">
                                <ItemTemplate>
                                    <asp:Button ID="btnHold" name="btnHold" runat="server" Height="22px" Font-Size="11px" CommandName="HOLD"
                                                Text="Hold" CssClass="all_button" Font-Bold="false" />
                                </ItemTemplate>
