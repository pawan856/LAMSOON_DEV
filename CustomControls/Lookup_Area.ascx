<%@ Control Language="VB" AutoEventWireup="false" CodeFile="Lookup_Area.ascx.vb" Inherits="CustomControls_WebUserControl" %>
<%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="asp" %>
<asp:UpdatePanel runat="server" ID="TEXTBOXUDP" RenderMode="Inline">
    <ContentTemplate>
        <asp:label ID="dsp_AREA_CODE" runat="server"  style="display:inline-block;  min-width: 100px;" /><asp:ImageButton ID="btnSearch" runat="server" ImageUrl="~/images/btn_search.gif" ALIGN="center"  />
        <asp:HiddenField runat="server" ID="AREA_CODE" />
        ...
        <asp:ModalPopupExtender ID="AREA_ModalPopupExtender" 
            runat="server" 
            DynamicServicePath=""
            Enabled="True" 
