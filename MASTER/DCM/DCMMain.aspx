<%@ Page Language="VB" AutoEventWireup="false" CodeFile="DCMMain.aspx.vb" Inherits="MASTER_DCM_DCMMain" %>
...
<head id="Head1" runat="server">
    ...
    <title>Batch No. Maintenance</title>
    ...
    <div id="div1">
        <table border="0" cellspacing="1" cellpadding="1" align="center" width="70%">
            ...
            <tr>
                <td class="LabelTD" width="25%" nowrap>
                    <font size="2">
                        <asp:Label ID="lbl_DC_DATE_CODE" runat="server" /> </font>
                </td>
                <td colspan="7">
                    <asp:textbox ID="DC_DATE_CODE" runat="server" Text="" Font-Size="10" MaxLength="20" 
            ...
            <tr>
                <td class="LabelTD" nowrap>
                    <font size="2">
                        <asp:Label ID="lbl_DC_CONV_DATE" runat="server" /> </font>
                </td>
                <td colspan="7">
                 <asp:TextBox ID="DC_CONV_DATE" runat="server" Width ="80" MaxLength="10" onkeypress="return maskDate(event);"></asp:TextBox>
                    <asp:ImageButton ID="btnDATE_ID1" runat="server" ImageUrl="../../images/calendar1.gif" 
                      ...
                      <asp:CalendarExtender ID="CalendarExtender1" runat="server" CssClass="ajax_calendar" 
                            TargetControlID="DC_CONV_DATE" PopupButtonID="btnDATE_ID1" Format="dd/MM/yyyy" />
                </td>
            </tr>
            <tr>
