<%@ Page Language="VB" AutoEventWireup="false" CodeFile="UOMMain.aspx.vb" Inherits="MASTER_UOM_UOMMain" %>
        ...
        <table border="0" cellspacing="1" cellpadding="1" align="center" width="70%">
            ...
            <tr>
                <td class="LabelTD" width="25%" nowrap>
                    <font size="2">
                        <asp:Label ID="lbl_UOM_CODE" runat="server" /> </font>
                </td>
                <td colspan="7">
                    <asp:textbox ID="UOM_CODE" runat="server" Text="" Font-Size="10" MaxLength="10" 
            ...
            <tr>
                <td class="LabelTD" nowrap>
                    <font size="2">
                        <asp:Label ID="lbl_UOM_DESC" runat="server" /> </font>
                </td>
                <td colspan="7">
                    <asp:textbox ID="UOM_DESC" runat="server" Text="" Font-Size="10" width="195px" 
            ...
            <tr>
                <td class="LabelTD" nowrap>
                    <font size="2">
                        <asp:Label ID="lbl_UOM_PCS" runat="server" /> </font>
                </td>
                <td colspan="7">
                    <asp:TextBox ID="UOM_PCS" runat="server"  Width="75px" MaxLength="4" />
                </td>
            </tr>
            <tr>
