...
<script language="javascript">
    ...
    function PrintLabel(STORER_CODE, itemStr, rt_code) {
            ...
            setInterfaceDataToForm(document.hiddenForm, "RT_CODE", rt_code);
            setInterfaceDataToForm(document.hiddenForm, "lblType", "SR");
        ...
        function PrintLabelCable(STORER_CODE, itemStr, rt_code) {
        removeAllElementFromForm(document.hiddenForm);
        ...
        <tr>
            <td>
                <asp:GridView ID="GridView1" runat="server" Height="10px" Width="100%" Font-Names="Arial"
                     ...
                     CellPadding="3" CaptionAlign="Top" DataKeyNames="RTD_seq" HorizontalAlign="Left">
                      ...
                      <Columns>
                         <asp:TemplateField >
                            ...
                            <ItemTemplate>
                                ...
                                <asp:HiddenField runat="server" ID="RTD_seq" />
                         ...
                         <asp:BoundField runat="server" DataField="RTD_PACK_KEY" HeaderText="Pack Key" HeaderStyle-HorizontalAlign="Left" />
                         <asp:BoundField runat="server" DataField="RTD_PALLET_NO" HeaderText="Pallet No" HeaderStyle-HorizontalAlign="Left" />
                         <asp:BoundField runat="server" DataField="RTD_BATCH_NO" HeaderText="Batch No" HeaderStyle-HorizontalAlign="Left" />
                         <asp:BoundField runat="server" DataField="RTD_ITM_NAME" HeaderText="Item Name" HeaderStyle-HorizontalAlign="Left" />
                         <asp:BoundField runat="server" DataField="ITM_TYPE" HeaderText="Item Type" HeaderStyle-HorizontalAlign="Left" />
                      </Columns> 
                </asp:GridView>
            </td>
        </tr> 
