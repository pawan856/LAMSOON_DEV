<%@ Page Language="VB" AutoEventWireup="false" CodeFile="pallet_labels.aspx.vb" Inherits="INBOUND_GR_GR_LABELS_gr_labels" %>
...
<body>
    ...
    <div>
         <rsweb:ReportViewer ID="ReportViewer1" runat="server" font-size="8pt"
            height="650px" style="position: static" width="1100px"></rsweb:ReportViewer>
    </div>
    </form>
</body>
</html>
