<%@ Page Language="VB" AutoEventWireup="false" CodeFile="carton_labels.aspx.vb" Inherits="INBOUND_GR_GR_LABELS_carton_labels" %>
...
<body>
    ...
    <div>
     &nbsp;<rsweb:ReportViewer ID="ReportViewer1" runat="server" font-size="8pt"
            height="650px" style="position: static" width="850px"></rsweb:ReportViewer>     
    </div>
    </form>
</body>
</html>
