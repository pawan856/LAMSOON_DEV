<%@ Page Language="VB" AutoEventWireup="false" CodeFile="item_label_print.aspx.vb" Inherits="INBOUND_GR_GR_LABELS_item_label_print" %>
...
<script language="javascript">
    ...
    function PrintLabel(STORER_CODE, itemStr, gr_code) {
            ...
            setInterfaceDataToForm(document.hiddenForm, "GR_CODE", gr_code);
            setInterfaceDataToForm(document.hiddenForm, "lblType", "GR");
   ...
   function PrintLabelCable(STORER_CODE, itemStr, gr_code) {
        removeAllElementFromForm(document.hiddenForm);

        window.open("", "printLabelC", "titlebar=0,location=0,menubar=0,toolbar=0,scrollbars=yes,personalbar=0,resizable=yes,status=1,width=800,height=600,left=5,top=15");
        ...
        <tr>
            <td>
                <asp:GridView ID="GridView1" runat="server" Height="10px" Width="100%" Font-Names="Arial"
                     ...
                     CellPadding="3" CaptionAlign="Top" DataKeyNames="grd_seq" HorizontalAlign="Left">
                      ...
                      <Columns>
                         <asp:TemplateField >
                            ...
                            <ItemTemplate>
                                ...
                                <asp:HiddenField runat="server" ID="grd_seq" />
                         ...
                         <asp:BoundField runat="server" DataField="GRD_PACK_KEY" HeaderText="Pack Key" HeaderStyle-HorizontalAlign="Left" />
                         <asp:BoundField runat="server" DataField="GRD_PALLET_NO" HeaderText="Pallet No" HeaderStyle-HorizontalAlign="Left" />
                         <asp:BoundField runat="server" DataField="GRD_BATCH_NO" HeaderText="Batch No" HeaderStyle-HorizontalAlign="Left" />
                         <asp:BoundField runat="server" DataField="GRD_ITM_NAME" HeaderText="Item Name" HeaderStyle-HorizontalAlign="Left" />
                         <asp:BoundField runat="server" DataField="ITM_TYPE" HeaderText="Item Name" HeaderStyle-HorizontalAlign="Left" />
                      </Columns> 
                </asp:GridView>
            </td>
        </tr> 
