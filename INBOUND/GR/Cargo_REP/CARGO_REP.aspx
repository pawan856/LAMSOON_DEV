<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CARGO_REP.aspx.vb" Inherits="CARGO_RCP_MAIN" %>
            ...
            <table border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="TITLE" colspan ="2">
                        <b><asp:Label ID="lheader" runat="server" text="Cargo Receipt" /></b>
                    </td>
                 </tr>
            </table>
        </td>
            ...
            <tr>
                <td class="menuTD" width="50%">
                    <input id="btnBack2" type="button" <%if Session("gLang") = "E" Then %>value="Close"
                        <% Elseif Session("gLang") = "C" Then %>value="關閉" <% End If%> onclick="Javascript:window.window.close();"
                        class="all_button" />
                </td>
