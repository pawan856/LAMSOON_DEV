...
<script language="javascript">
    ...
    function PrintLabel(STORER_CODE, itemStr, ro_code) {
            ...
            setInterfaceDataToForm(document.hiddenForm, "RO_CODE", ro_code);
            setInterfaceDataToForm(document.hiddenForm, "lblType", "RO");
                ...
                <asp:GridView ID="GridView1" runat="server" Height="10px" Width="100%" Font-Names="Arial"
                     ...
                     CellPadding="3" CaptionAlign="Top" DataKeyNames="ROD_seq" HorizontalAlign="Left">
                      ...
                      <Columns>
                         ...
                         <asp:BoundField runat="server" DataField="ROD_PACK_KEY" HeaderText="Pack Key" HeaderStyle-HorizontalAlign="Left" />
                         <asp:BoundField runat="server" DataField="ROD_PALLET_NO" HeaderText="Pallet No" HeaderStyle-HorizontalAlign="Left" />
                         <asp:BoundField runat="server" DataField="ROD_BATCH_NO" HeaderText="Batch No" HeaderStyle-HorizontalAlign="Left" />
                         <asp:BoundField runat="server" DataField="ROD_ITM_NAME" HeaderText="Item Name" HeaderStyle-HorizontalAlign="Left" />
