<%@ Page Language="VB" AutoEventWireup="false" CodeFile="UserGPSearchFun.aspx.vb" Inherits="UserGPSearchFun" %>
...
<body bgcolor="#FFFFFF" text="#000000" leftmargin="0" topmargin="0" marginwidth="0"
        ...
        **********************
        ...
        -->
            <tr>
                ...
                <td>
                    <asp:TextBox ID="grp_code" runat="server" Width="200"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="LabelTD">
                ...
                <td>
                    <asp:TextBox ID="grp_name" runat="server" Width="400" />
                </td>
            </tr>
            <!--
        **********************
    ...
    <div id="div2">
        <asp:GridView ID="gvrsList" runat="server" Height="10px" Width="100%" AllowPaging="True"
            ...
            BorderWidth="1px" CellPadding="3" CaptionAlign="Top" DataKeyNames="grp_code"  PageSize="20">
            ...
            <Columns>
                <asp:HyperLinkField DataNavigateUrlFields="grp_code" DataNavigateUrlFormatString="UserGPMain.aspx?grp_code={0}"
                    DataTextField="grp_code" HeaderText="User ID">
                    <ItemStyle Font-Size="11px" />
                </asp:HyperLinkField>
                <asp:BoundField DataField="grp_name" HeaderText="User Name">
